...
public class ConsolaOlimpicos
{
	...
	// Le muestra al usuario el país del atleta buscado
	private void ejecutarPaisAtlteta() {
		String nombreAtleta = input("Por favor ingrese el nombre del atleta a buscar: " + "\n");
		String paism = calculadora.paisDelAtleta(nombreAtleta);
		if (paism == null)
		{
			System.out.println("El Atlteta no se encontró en la base");
		}
		else
		{
			System.out.println("El país del atleta consultado es: " + paism);
		}
